...
public class ConnectFour {
    ...
    private Scanner scannerN = new Scanner(System.in);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("-- Only type in the numbers/columns 1-7 or your turn will be skipped --");
    ...
    public void playConnectFourRowN(int n) {
        String[][] gameboardN = new String[n][7];
        int N = n - 1;
        for(int y = 0; y < n; y++) {
            for (int i = 0; i < 7; i++) {
                gameboardN[y][i] = " ";
                    ...
                    while (placeTile == true) {
                        for (int i = 0; i <= n; i++) {
                            if (forLoop == true) {    
                                ...
                                if (gameboardN[i][scannerVariable].equals(" ")) {
                                    gameboardN[i][scannerVariable] = "X";
                                    forLoop = false;
                                    placeTile = false;
                                }
                            }
                        ...
                        for (int i = N; i >= 0; i--) {
                            System.out.println("| "+gameboardN[i][0]+" | "+gameboardN[i][1]+" | "+gameboardN[i][2]+" | "+gameboardN[i][3]+" | "+gameboardN[i][4]+" | "+gameboardN[i][5]+" | "+gameboardN[i][6]+" |");
                        }
                        System.out.println("");
                        System.out.println("- "+"1"+" - "+"2"+" - "+"3"+" - "+"4"+" - "+"5"+" - "+"6"+" - "+"7"+" -");
                    ...
                    while (placeTile == true) {
                        for (int i = 0; i <= n; i++) {
                            if (forLoop == true) {    
                                ...
                                if (gameboardN[i][scannerVariable].equals(" ")) {
                                    gameboardN[i][scannerVariable] = "O";
                                    forLoop = false;
                                    placeTile = false;
                                }
                            }
